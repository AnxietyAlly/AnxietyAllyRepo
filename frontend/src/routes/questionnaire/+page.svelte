...
<div class="min-h-screen bg-sky flex flex-col items-center">
	...
	<!--this is the footer with back and forward button-->
			...
			<div class="score-container items-center mt-4 flex flex-col justify-center">
				<div class="score bg-blue-500 text-white rounded-full items-center">
					Social Anxiety with a score of: {getScore()}
				</div>
				<div class="mt-36">
					<button class="bg-blue-500 text-white rounded-full focus:outline-none border-radius-20 h-14 w-24" on:click={restartQuiz}>
						Restart Quiz
					</button>
					<a href="/dashboard" class="bg-blue-500 text-white rounded-full focus:outline-none border-radius-20 py-4 px-2" on:click={restartQuiz}>
						Continue
					</a>
				</div>
